...
our %config = (
  ...
  builddir => ".",
  cflags => [  ],
  conf_files => [ "C:\\cpython-3.11.1\\externals\\openssl-1.1.1q\\Configurations\\00-base-templates.conf", "C:\\cpython-3.11.1\\externals\\openssl-1.1.1q\\Configurations\\10-main.conf", "C:\\cpython-3.11.1\\externals\\openssl-1.1.1q\\Configurations\\50-masm.conf" ],
  cppflags => [  ],
  cxxflags => [  ],
  defines => [ "NDEBUG" ],
